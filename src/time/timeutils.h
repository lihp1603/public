...
#ifndef __ME_TIMEUTILS_H_
#define __ME_TIMEUTILS_H_
...
static const int64_t kNumMillisecsPerSec = INT64_C(1000);//毫秒
static const int64_t kNumMicrosecsPerSec = INT64_C(1000000);//微秒
static const int64_t kNumNanosecsPerSec = INT64_C(1000000000);//纳秒
